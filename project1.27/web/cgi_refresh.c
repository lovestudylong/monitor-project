...
int main(int argc, const char *argv[])
{
	...
	printf("<html>\n");
    printf("<script> \
    function show(){var date = new Date(); \
    var now = \"\"; \
    ...
    printf("<h3 align=center><body onload=\"show()\"> <div id=\"nowDiv\"></div></h3>\n");

    printf("<h4>ADC数据：</h4>\n");
    printf("<p>adc:%dmv</p>\n", env_data_buf->adc);
    printf("<h4>MPU6050数据：</h4>\n");
    printf("<p>gyrox:%d</p>\n", env_data_buf->gyrox);
    printf("<p>gyroy:%d</p>\n", env_data_buf->gyroy);
    printf("<p>gyroz:%d</p>\n", env_data_buf->gyroz);
    printf("<p>aacx:%d</p>\n", env_data_buf->aacx);
